        ...
        <section className=" max-w-7xl mx-auto pb-20">
          <div className=" flex items-center mt-2 mx-4 md:mx-0 ">
            <p className=" whitespace-nowrap tracking-tighter border-b border-black text-2xl py-4 font-medium capitalize">
              {post[0].categories[0].description}
            </p>
            <div className=" w-full border-b py-8" />
          </div>
          <div className="  ">
            <div className=" flex flex-col my-20 space-x-4 ">
              <div className="">
                ...
                <div className=" grid gap-4 my-2 grid-cols-1 md:grid-cols-2 pt-8 md:pt-12">
                  ...
                  <div className=" space-y-4">
                    {post
                      .filter((x: Post, y: number) => y & 1 && y > 0)
                      .map((x: Post, y: number) => (
                        <SideCard key={y} data={x} shade />
                      ))}
                  </div>
                </div>
              </div>
              <div className=" ">
                <p className=" text-xl mb-6 font-medium border-b-2 max-w-max pb-2 border-black">
                  Recently Uploaded
                </p>
