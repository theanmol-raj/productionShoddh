    ...
    <div className='rounded-lg border '>
        ...
        <div className='pt-20 px-6 pb-8'>
          <h1 className=' text-center text-xl font-serif font-bold'>{data?.name}</h1>
            ...
            <div className=''>
            <button  className=' text-lg border-black border font-bold w-full py-2 my-2 mt-8'><Link className=' bg-red-500' href={`/author/${data.slug.current}`}>Visit Profile</Link></button> 
