        ...
        <div className='pt-20 px-6 pb-8'>
          <h1 className=' text-center text-xl font-serif font-bold'>{data?.name}</h1>
            ...
            <div className=''>
              ...
              <Link className=' bg-red-500 py-2 w-full' href={`/author/${data.slug.current}`}><button  className=' text-lg border-black border font-bold w-full py-2 my-2 mt-8'>Visit Profile
              </button> </Link>
