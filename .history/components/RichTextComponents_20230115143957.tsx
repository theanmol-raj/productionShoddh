...
export const RichTextComponents = {
    ...
    block : {
        ...
        h3: ({children}: any) => ({children}: any) =><h2 className="text-2xl my-5 font-semibold">{children} </h2>,
        h4: ({children}: any) =><h2 className="text-2xl my-5 font-semibold">{children} </h2>,
        normal: ({children}: any) => ({children}: any) =><h2 className="text-2xl my-5 font-semibold">{children} </h2>,
    }
}
