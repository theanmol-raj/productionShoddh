...
function StudioNavbar(props :any) {
  return (
    <div className="bg-[#1a1a1a]">
        <div
      className={` mediumnavigation  transform transition duration-200 ease-in-out  border-b right-0 bg-white left-0 z-50 '`}
    >
      {true && <div className=" relative bg-gradient-to-r from-yellow-400 via-green-400 to-purple-500 text-white py-2 text-center">
