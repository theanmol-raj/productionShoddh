      ...
      <div>
        ...
        <div className=" max-h-[600px] flex ">
            <div className=" hidden md:block md:w-2/3">
                <img src={urlFor(data[0].mainImage).url()}  className=" w-full object-center object-cover h-[600px]" alt="The 25 best European city breaks for 2022 and beyond"  />
            </div>
            <div className="md:w-1/3 flex flex-col  items-center bg-yellow-400/95">
                <div className=" py-12 px-8">
                <p className=" uppercase  text-yellow-800 tracking-widest">Today's Featured Post </p>
                <p className=" text-3xl md:text-5xl capitalize pt-6 pb-2 font-black ">{data[0]?.title}</p>
                <hr className=" border-black border-2 mr-4 mt-4" />
                <p className=" py-6 text-yellow-900 leading-6 md:text-lg">{data[0]?.description}</p>
